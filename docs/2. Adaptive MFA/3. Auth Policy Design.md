...
Exported files:
- [`configs/auth-policies.json`](https://github.com/bennhood/Okta-IAM-Lab/blob/main/configs/auth-policies.json) - all tenant policies
- [`configs/acmecorp-policy-rules.json`](https://github.com/bennhood/Okta-IAM-Lab/blob/main/configs/acmecorp-policy-rules.json) - AcmeCorp Global Policy rules
